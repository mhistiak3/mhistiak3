...
- ![Docker](https://img.shields.io/badge/-Docker-2496ED?logo=docker&logoColor=white&style=flat) **Docker**: Containerization for consistent environments.
- ![GitHub](https://img.shields.io/badge/-GitHub-181717?logo=github&logoColor=white&style=flat) **Git & GitHub**: Version control & collaboration.
- ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white&style=flat) **TypeScript**: Typed superset of JavaScript.
...
- **Description**: A full-stack private chat app with real-time messaging.
...
- **Description**: An intuitive app for taking notes with tags and filtering options.
...
- **Description**: A blog writing platform where users can create and share blogs.
- **Technologies**: Node.js, Express, MongoDB, EJS, JWT.
